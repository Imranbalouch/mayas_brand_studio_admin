document.title="Dashboard | Add Carrier";
$(document).ready(function () {
    // Form submission handler
    $("#CarrierAddForm").on("submit", function (e) {
        e.preventDefault();
        ...
        $.ajax({
            url: ApiPlugin + '/ecommerce/carriers/store',
            type: "POST",
            ...
            success: function (response) {
                ...
                if (response.status_code === 200) {
                    ...
                    showToast(response.message || "Failed to add carrier", "Error", "error");
                }
            },
