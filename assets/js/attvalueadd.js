document.title="Dashboard | Add Attribute Values";
$("#addAttributeForm").on("submit", function (e) {
    ...
    $.ajax({
        url: ApiPlugin + "/ecommerce/attribute/store_attribute_value",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
        ...
        success: function (response) {
            ...
            if (response.status_code == 200) {
                ...
                showToast(title, 'Success', 'success', "?P=attributevaluesadd&M="+menu_id+"&id="+id);
            }
        },
