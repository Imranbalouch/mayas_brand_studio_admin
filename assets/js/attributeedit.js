document.title = "Dashboard | Edit Attribute";
var urlParams = new URLSearchParams(window.location.search);
var id = urlParams.get('id');

if (id) {
    $.ajax({
        url: ApiPlugin + "/ecommerce/attribute/edit_attribute/" + id,
        ...
        success: function (response) {
            ...
            if (response.status_code == 200) {
                ...
                console.log("Setting attribute name to:", data.attribute_name);
                                     ...
                                     <div class="row">
                                         <div class="mb-6 fv-row col-md-12">
                                             ...
                                             <input type="text" class="form-control mb-2" id="name_${translation.language_code}"
                                                 name="name_${translation.language_code}" value="${translation.attribute_name}" required>
                                         </div>
                                     </div>
                                 </div>
                             </div>
...
$("#editAttributeForm").on("submit", function (e) {
    ...
    $.ajax({
        url: ApiPlugin + "/ecommerce/attribute/update_attribute",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
