	...
	$( document ).ready(function() {
		function c(passed_month, passed_year, calNum) {
			...
			clickedElement.on("click", function(){
                ...
                bothCals.find(".calendar_content").find("div").removeClass("selected");
            
                // Select only the clicked date
                ...
                var selectedDate = firstClicked.date + " " + i[firstClicked.month] + " " + firstClicked.year;
            
                // Insert into #putdate
                $("#putdate").val(selectedDate);
            });

			// Initial
			let currentDate = new Date();

			$("#putdate").val(`${currentDate.getDate()} ${currentDate.toLocaleString('default', { month: 'long' })} ${currentDate.getFullYear()}`); 
