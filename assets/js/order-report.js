document.title = "Dashboard | Order Report";
let PageNo = 1;
let PageSize = 10;
let totalRecord = 0;
let PageLength = 0;
...
function Onload() {
    ...
    $('#buttons').html('');
    $.ajax({
        url: ApiPlugin + '/ecommerce/order_report',
        type: "Get",
            ...
            if (response.status_code == 200) {
                ...
                if (response["data"] != null) { 
                    ...
                    const columnsConfig = [ 
                        ...
                        { data: 'grand_total',
                            render: function (data, type, row) {
                               return row.grand_total ? 'AED '+row.grand_total : '';
                            }
                        },
                        { data: 'mark_as_paid',
                            render: function (data, type, row) {
                        ...
                        { data: 'delivery_status',
                            render: function (data, type, row) {
                                return row.delivery_status ? row.delivery_status : '';
                            }
                        },
                        { data: 'payment_method',
                            render: function (data, type, row) {
