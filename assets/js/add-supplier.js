document.title="Dashboard | Add Supplier";
$(document).ready(function () {
        ...
        function validatePhoneInput() {
            if (phoneInput.value.trim()) {
                if (iti.isValidNumber()) {
                    ...
                    $("#SupplierAddForm").find("#btn_sav").prop("disabled", false);
                    ...
                    $("#SupplierAddForm").find("#btn_sav").prop("disabled", true);
    ...
    $("#SupplierAddForm input, #SupplierAddForm select").on("input change", function () {
