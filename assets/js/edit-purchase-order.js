document.title="Dashboard | Edit Purchase Order";
let PageNo = 1;
let PageSize = 1;
let totalRecord = 0;
let PageLength = 0;
...
$(document).ready(function () {
    ...
    $("#AddProduct").on("click", function () {
        ...
        productList.each(function (key) {
            ...
            let varaintProduct = [];
            // console.log("varaintProduct",$(this).find(".product-name").text().trim());
            // console.log("varaintProduct",$(this).find(".product-name img").attr("src"));
...
function calculatePOS(e) {
    ...
    $("#shipping-fee").text("Rs " + shippingFee);
