...
(function () {
  ...
  if (layoutMenuEl.length > 0) {  // Only proceed if elements are found
    layoutMenuEl.forEach(function (element) {
      ...
      window.Helpers.scrollToActive(false); // Pass `false` for no animation
      window.Helpers.mainMenu = menu;
    });
  } else {
    console.warn("No element with ID 'layout-menu' found.");
  }
